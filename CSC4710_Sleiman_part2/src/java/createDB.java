    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{  
                    ...
                    String query1 = "CREATE TABLE authors(\n" +
                    ...
                    String query2 = "CREATE TABLE conference_papers(\n" +
                                    "id INT PRIMARY KEY NOT NULL AUTO_INCREMENT ,\n" +
                                    "tittle VARCHAR(100),\n" +
                                    ...
                                    "fauthor INT,\n" +
                                    "sauthor INT,\n" +
                                    "FOREIGN KEY (fauthor) REFERENCES authors(id),"
                                    + "FOREIGN KEY (sauthor) REFERENCES authors(id));";
                    ...
                    String query6 = "insert into authors values(0,\"Scott\",\"Allen\",\"scot23@gmail.com\",\"Amy\"),\n" +
                                    "(0,\"Richard A.\",\"Posner\",\"posner@gmail.com\",\"Heslop\"),\n" +
                                    "(0,\"Elizabeth\",\"Bryman\",\"rowley@gmail.com\",\"Tim\"),\n" +
                                    "(0,\"V. V.\",\"Volkov\",\"volkov@gmail.com\",\"Richard\"),\n" +
                                    "(0,\"Alan\",\"Bryman\",\"alan@gmail.com\",\"jimmy\"),\n" +
                                    "(0,\"Kin-Lu\",\"Wong\",\"kni@gmail.com\",\"Tom\"),\n" +
                                    "(0,\"Jolivet\",\"Dan\",\"joli232@gmail.com\",\"Scott\"),\n" +
                                    "(0,\"Matt\",\"Papadopoulos\",\"papado67@gmail.com\",\"Ray\"),\n" +
                                    "(0,\"Derry\",\"FitzGerald\",\"derry@yahoo.com\",\"Walton\"),\n" +
                                    "(0,\"Matthew\",\"Jones\",\"jones@gmail.com\",\"Chris\");";
                    ...
                    String query7 = "insert into conference_papers values (0,\"Regions and the World Economy\",\"One of the dramatic shifts that is occurring in the world system as \n" +
                                    "we enter the twenty-first century is the increasing openness and interpenetration of national economies and sovereign states. \",\"1.pdf\",1,2),\n" +
                                    ...
                                    "philosophical problems.\",\"2.pdf\",1,5),\n" +
                                    ...
                                    " the visual dimension.\",\"3.pdf\",1,8),\n" +
                                    ...
                                    " are indicated, which require additional information for reliable shape reconsrtuction from the scattering data.\",\"4.pdf\",3,5),\n" +
                                    ...
                                    " a mixed-methods esearch approach and the ways it is used in practice indicates that the two do not always correspond. \",\"5.pdf\",6,3),\n" +
                                    ...
                                    " The intent of this book is to organize and present these advanced designs in the area of planar antennas for wireless communications. \",\"6.pdf\",9,2),\n" +
                                    ...
                                    " suggests approaches for strategy development as well as pointing to knowledge gaps that call for additional research.\",\"8.pdf\",9,4),\n" +
                                    ...
                                    " the Group would seem a potentially important forum for research that seeks to address the social dimension of IS. \",\"10.pdf\",8,5);";       
                    
                    String query8 = "insert into pc_members values(0,\"David\",\"david@gmail.com\",\"david\",\"member\"),\n" +
                                    "(0,\"Richard\",\"richard@gmail.com\",\"richard\",\"member\"),\n" +
                                    "(0,\"Elisa\",\"elisa@gmail.com\",\"elisa\",\"member\"),\n" +
                                    "(0,\"Stuart\",\"stuart@gmail.com\",\"stuart\",\"member\"),\n" +
                                    "(0,\"Aberman\",\"abreman@gmail.com\",\"abreman\",\"member\"),\n" +
                                    "(0,\"Petter\",\"petter@gmail.com\",\"petter\",\"member\"),\n" +
                                    "(0,\"John\",\"john@gmail.com\",\"admin123\",\"conference manager\"),\n" +
                                    "(0,\"Paul\",\"paul@gmail.com\",\"paul\",\"member\"),\n" +
                                    "(0,\"Sarah\",\"sarah@gmail.com\",\"sarah\",\"member\"),\n" +
                                    "(0,\"James\",\"james@gmail.com\",\"james\",\"member\");";
                    
                    String query9 = "insert into reports values(0,\"I like it\",\"accept\",\"2012-02-02\",3,1),\n" +
                    ...
                    String query10 = "insert into member_assigning values(5,4),\n" +
                                    "(5,3),\n" +
                                    "(8,8),\n" +
                                    "(3,3),\n" +
                                    "(9,5),\n" +
                    ...
                    response.sendRedirect("http://localhost:8080/ConferenceWebsite/loginpage.html");
                    conn1.close();
                    conn.close();  
                }catch(Exception ex){ 
                    out.println(ex);
