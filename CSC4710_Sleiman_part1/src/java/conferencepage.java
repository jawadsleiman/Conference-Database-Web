        ...
        try (PrintWriter out = response.getWriter()) {
            try{ 
                ...
                out.println("<!DOCTYPE html>\n" +
                        ...
                        "<body>\n" +
                        "\n" +
                        "<center><div class=\"container\"><div style='float:left'><a href='http://localhost:8080/ConferenceWebsite/conferencepage'>"+
						"<button class='btn'>Accepted Papers</button></a><a href='http://localhost:8080/ConferenceWebsite/conferencepage'>"+
						"<button class='btn'>Rejected Papers</button></a><a href='http://localhost:8080/ConferenceWebsite/members'>"+
